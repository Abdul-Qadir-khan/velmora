...
export default function About() {
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-50 via-white to-indigo-50">
      ...
      <section className="relative overflow-hidden bg-linear-to-r from-indigo-600 via-purple-600 to-pink-600 text-white py-20 sm:py-24 md:py-28 lg:py-32 px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="order-2 lg:order-1">
              ...
              <div className="space-y-4 sm:space-y-6">
                <div className="flex items-start gap-3 sm:gap-4 p-5 sm:p-6 bg-linear-to-r from-indigo-50 to-purple-50 rounded-2xl">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-indigo-600 rounded-xl sm:rounded-2xl flex items-center justify-center shrink-0 mt-1">
                ...
                <div className="flex items-start gap-3 sm:gap-4 p-5 sm:p-6 bg-linear-to-r from-indigo-50 to-purple-50 rounded-2xl">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-purple-600 rounded-xl sm:rounded-2xl flex items-center justify-center shrink-0 mt-1">
            ...
            <div className="order-1 lg:order-2 relative">
              ...
              <div className="absolute -bottom-4 sm:-bottom-6 -right-4 sm:-right-6 w-20 sm:w-32 h-20 sm:h-32 lg:w-32 lg:h-32 bg-linear-to-r from-indigo-500 to-purple-500 rounded-2xl opacity-20"></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 lg:px-8 bg-linear-to-b from-slate-50 to-white">
        <div className="max-w-6xl mx-auto text-center">
          <h3 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-6 px-4">
            Our{' '}
            <span className="text-transparent bg-clip-text bg-linear-to-r from-pink-600 via-red-600 to-orange-600">
              Mission
            </span>
          </h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-5xl mx-auto mt-12 sm:mt-16">
            <div className="p-6 sm:p-8 bg-white/70 backdrop-blur-sm rounded-2xl sm:rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 border border-white/50 group hover:-translate-y-2">
              <div className="w-16 h-16 sm:w-20 sm:h-20 bg-linear-to-r from-pink-500 to-red-500 rounded-xl sm:rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform">
            ...
            <div className="p-6 sm:p-8 bg-white/70 backdrop-blur-sm rounded-2xl sm:rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 border border-white/50 group hover:-translate-y-2">
              <div className="w-16 h-16 sm:w-20 sm:h-20 bg-linear-to-r from-indigo-500 to-purple-500 rounded-xl sm:rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform">
                <span className="text-xl sm:text-2xl font-bold text-white">🌿</span>
              </div>
            ...
            <div className="p-6 sm:p-8 bg-white/70 backdrop-blur-sm rounded-2xl sm:rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 border border-white/50 group hover:-translate-y-2">
              <div className="w-16 h-16 sm:w-20 sm:h-20 bg-linear-to-r from-emerald-500 to-teal-500 rounded-xl sm:rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform">
                <span className="text-xl sm:text-2xl font-bold text-white">🎨</span>
              </div>
      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 bg-linear-to-r from-indigo-600/10 via-purple-600/10 to-pink-600/10">
      ...
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link 
            href="/contact"
            className="inline-flex items-center gap-2 sm:gap-3 px-8 sm:px-12 py-4 sm:py-5 bg-linear-to-r from-indigo-600 to-purple-600 text-white font-semibold text-base sm:text-lg rounded-full hover:from-indigo-700 hover:to-purple-700 transition-all duration-300 shadow-xl hover:shadow-2xl hover:-translate-y-1"
          >
            Get In Touch
            <ChevronRightIcon className="w-4 h-4 sm:w-5 sm:h-5 group-hover:translate-x-1 transition-transform" />
          </Link>
